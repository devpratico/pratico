...
VALUES
    (
        ...
        'bd745bf6-b800-4b3e-b121-b44baa80de59',
        'authenticated',
        'authenticated',
        'test@test.com',
        '$2a$10$MrkZK8kG2n50J1ykM0snlupn5MYhmL2r.8FibgylD9fh5sDKeA3S.',
        '2025-03-20 16:02:33.341316+00',
        NULL,
        '',
        NULL,
        '',
        ...
        '',
        NULL,
        '2025-03-20 16:02:33.342926+00',
        '{"provider": "email", "providers": ["email"]}',
        '{"sub": "bd745bf6-b800-4b3e-b121-b44baa80de59", "email": "test@test.com", "email_verified": false, "phone_verified": false}',
        NULL,
        '2025-03-20 16:02:33.33522+00',
        '2025-03-20 16:02:33.344222+00',
        NULL,
        NULL,
        '',
        '',
...
VALUES
    (
        ...
        '{"sub": "bd745bf6-b800-4b3e-b121-b44baa80de59", "email": "test@test.com", "email_verified": false, "phone_verified": false}',
        'email',
        '2025-03-20 16:02:33.339339+00',
        '2025-03-20 16:02:33.339366+00',
        '2025-03-20 16:02:33.339366+00',
        'de0b4234-8085-44ed-b509-d0b3157bb8f3'
    );
...
VALUES
    (
        '00000000-0000-0000-0000-000000000000',
        'ef0e0a37-ee20-49ca-869b-23bbffdb39fe',
        'authenticated',
        'authenticated',
        NULL,
        '',
        ...
        '',
        NULL,
        '2025-03-21 10:37:18.059015+00',
        '{}',
        '{}',
        NULL,
        '2025-03-21 10:37:18.056551+00',
        '2025-03-21 10:37:18.060178+00',
        NULL,
        NULL,
        '',
        '',
    ...
    (
        '00000000-0000-0000-0000-000000000000',
        '7310822a-f760-4af0-92e9-d18d9939aaf5',
        'authenticated',
        'authenticated',
        NULL,
        '',
        ...
        '',
        NULL,
        '2025-03-21 10:39:52.540094+00',
        '{}',
        '{}',
        NULL,
        '2025-03-21 10:39:52.53862+00',
        '2025-03-21 10:39:52.5413+00',
        NULL,
        NULL,
        '',
        '',
    ...
    (
        '00000000-0000-0000-0000-000000000000',
        'e10286ef-b820-4ff5-95ca-6c647009d163',
        'authenticated',
        'authenticated',
        NULL,
        '',
        ...
        '',
        NULL,
        '2025-03-21 10:40:59.446053+00',
        '{}',
        '{}',
        NULL,
        '2025-03-21 10:40:59.444652+00',
        '2025-03-21 10:40:59.447197+00',
        NULL,
        NULL,
        '',
        '',
