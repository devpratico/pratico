interface FontMonoIconProps {
    className?: string;
  }


export default function FontMonoIcon({className}: FontMonoIconProps) {
    return (
        <svg
