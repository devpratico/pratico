...
export default function YoutubeIcon({className, size}: IconProps) {

    const style = size ? {width: iconSizeMap[size], height: iconSizeMap[size]} : className ? undefined : {width: "100%", height: "100%"};
