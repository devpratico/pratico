...
import CameraIcon from '@/app/(frontend)/[locale]/_components/icons/CameraIcon';
import YoutubeIcon from '@/app/(frontend)/[locale]/_components/icons/YoutubeIcon';
import FileEarmarkImageIcon from '@/app/(frontend)/[locale]/_components/icons/FileEarmarkImageIcon';
