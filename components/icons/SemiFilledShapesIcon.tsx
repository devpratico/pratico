...
export default function SemiFilledShapesIcon({className,  size}: IconProps) {
    ...
    const EmptyPath = () => (
        <g>
            ...
            <path d="M5.13473 10.0512L0.986726 10.0512L0.986726 0.911715L10.1262 0.911715L10.1262 5.06289L6.37898 6.48387L5.13473 10.0512Z" fill="currentColor" fillOpacity="0.5" fillRule="nonzero" opacity="1" stroke="none"/>
            <path d="M5.1379 10.0512C5.1379 7.29623 7.37124 5.06289 10.1262 5.06289C12.8812 5.06289 15.1145 7.29623 15.1145 10.0512C15.1145 12.8062 12.8812 15.0395 10.1262 15.0395C7.37124 15.0395 5.1379 12.8062 5.1379 10.0512Z" fill="currentColor" fillOpacity="0.5" fillRule="nonzero" opacity="1" stroke="currentColor" strokeLinecap="butt" strokeLinejoin="round" strokeWidth="1"/>
        </g>
    )
