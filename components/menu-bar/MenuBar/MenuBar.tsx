 ...
 */
export default async function MenuBar({ mode, hideLabels }: MenuBarProps) {
        ...
        case "creation":
            return (
                <MenuBarLayout spacerPosition={3}>
                    ...
                    <LabeledIconBtn icon={<PlayCircleIcon/>}  label={t('play')}        {...styleBtnProps} />
                    <LabeledIconBtn icon={<PuzzleIcon/>}      label={t('polls')}      {...styleBtnProps} />
                    <LabeledIconBtn icon={<ThreeDotsIcon/>}   label={t('polls')}       {...styleBtnProps} />
                </MenuBarLayout>
            )
